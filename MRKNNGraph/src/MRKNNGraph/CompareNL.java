...
class CompareNLMapper extends Mapper<LongWritable, Text, Node, NeighborList>{
...
class CompareNLReducer extends Reducer<Node, NeighborList, NullWritable, NullWritable> {
